...
public class MaGiamGiaRepository implements IMaGiamGiaRepository {
    ...
    public boolean insertMaGiamGia(MaGiamGiaDomainModel maGiamGiaDomainModel) {
        boolean flag=false;
        flag=
                maGiamGiaDomainModel.getGiamToiDa().longValue()<=0||
                        maGiamGiaDomainModel.getDonToiThieu()<=0||
                        maGiamGiaDomainModel.getPhanTramGiam()<=0||
                        maGiamGiaDomainModel.getPhanTramGiam()>100;
        if(!flag){
